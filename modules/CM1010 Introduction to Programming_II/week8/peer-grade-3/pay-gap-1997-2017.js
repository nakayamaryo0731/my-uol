  ...
  this.draw = function () {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      if (previous != null) {
        ...
        // line( ??? );
        console.log(current)
        let x1 = this.mapYearToWidth(previous.year);
        let y1 = this.mapPayGapToHeight(previous.payGap)
        let x2 = this.mapYearToWidth(current.year);
        let y2 = this.mapPayGapToHeight(current.payGap)
        line(x1, y1, x2, y2);
